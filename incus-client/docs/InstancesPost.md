...
**instance_type** | Option<**String**> | Cloud instance type (AWS, GCP, Azure, ...) to emulate with limits | [optional]
...
**source** | Option<[**models::InstanceSource**](InstanceSource.md)> |  | [optional]
**start** | Option<**bool**> | Whether to start the instance after creation | [optional]
