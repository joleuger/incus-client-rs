...
/// InstanceSnapshotGet200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstanceSnapshotGet200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::InstanceSnapshot>>,
    /// Status description
...
impl InstanceSnapshotGet200Response {
    /// Sync response
    pub fn new() -> InstanceSnapshotGet200Response {
