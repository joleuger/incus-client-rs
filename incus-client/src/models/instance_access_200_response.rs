...
/// InstanceAccess200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstanceAccess200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Vec<models::AccessEntry>>,
    /// Status description
...
impl InstanceAccess200Response {
    /// Sync response
    pub fn new() -> InstanceAccess200Response {
