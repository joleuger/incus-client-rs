...
/// InstanceStateGet200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstanceStateGet200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::InstanceState>>,
    /// Status description
...
impl InstanceStateGet200Response {
    /// Sync response
    pub fn new() -> InstanceStateGet200Response {
