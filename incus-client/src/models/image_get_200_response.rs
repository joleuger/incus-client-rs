...
/// ImageGet200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImageGet200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::Image>>,
    /// Status description
...
impl ImageGet200Response {
    /// Sync response
    pub fn new() -> ImageGet200Response {
        ImageGet200Response {
            metadata: None,
            status: None,
            status_code: None,
