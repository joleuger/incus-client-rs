...
/// InstanceBackupGet200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstanceBackupGet200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::InstanceBackup>>,
    /// Status description
...
impl InstanceBackupGet200Response {
    /// Sync response
    pub fn new() -> InstanceBackupGet200Response {
