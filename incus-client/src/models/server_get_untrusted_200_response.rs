...
/// ServerGetUntrusted200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ServerGetUntrusted200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::ServerUntrusted>>,
    /// Status description
...
impl ServerGetUntrusted200Response {
    /// Sync response
    pub fn new() -> ServerGetUntrusted200Response {
