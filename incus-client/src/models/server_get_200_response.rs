...
/// ServerGet200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ServerGet200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::Server>>,
    /// Status description
...
impl ServerGet200Response {
    /// Sync response
    pub fn new() -> ServerGet200Response {
