...
/// InstanceGet200Response : Sync response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstanceGet200Response {
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::Instance>>,
    /// Status description
...
impl InstanceGet200Response {
    /// Sync response
    pub fn new() -> InstanceGet200Response {
